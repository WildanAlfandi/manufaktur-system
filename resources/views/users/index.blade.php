                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="text-2xl font-bold text-green-600">
                            {{ \App\Models\User::where('role', 'staff')->count() }}</div>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-sm font-medium text-gray-500">Active Now</div>
                                                ...
                                                @if ($user->id !== auth()->id())
                                                    ...
                                                    <form action="{{ route('users.reset-password', $user) }}"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            onclick="return confirm('Reset password untuk user {{ $user->name }}?')">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
